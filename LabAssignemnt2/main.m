% main.m - Multi-Robot Book Sorting System with GUI Control
% Lab Assignment 2 - Industrial Robotics
% Main entry point - Run this file to start the system
% Features: GUI Control, E-Stop, Sensor Simulation, Joint/Cartesian Jogging, Automated Book Sorting Demo
...
fprintf('  🔄 RESET:           Reset all robots to home positions\n\n');
...
fprintf('RESET FUNCTIONALITY:\n');
fprintf('  Click the "🔄 RESET SYSTEM" button to:\n');
fprintf('  - Move all robots back to home positions\n');
fprintf('  - Clear and respawn books at original locations\n');
fprintf('  - Reset all safety systems\n');
fprintf('  - Allow demo to be restarted fresh\n\n');
